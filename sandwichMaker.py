...
condimentPrices = {
    "mayo": 0.50,
    "mustard": 0.50,
    "1000 Island Dressing & Sauerkraut": 1.00,
    "tomato": 0.50,
    "onion": 0.75,
    "lettuce": 0.25,
}
...
while True:
    ...
    breadType = pyip.inputMenu(
        ["wheat", "white", "sourdough", "rye"],
        "What kind of bread would you like for your sandwich?\n",
    )
    protein = pyip.inputMenu(
        ["chicken", "turkey", "ham", "tofu", "corned beef"],
        "Good choice! What kind of meat are we having on your sandwich?\n",
    )
    ...
    condiments = pyip.inputMenu(
        [
            "mayo",
            "mustard",
            "1000 Island Dressing & Sauerkraut",
            "tomato",
            "onion",
            "lettuce",
        ],
        "Alright, what other toppin's would you like?\n",
    )
    ...
    print(
        "Well, that bring's your price today to "
        + str(totalCost)
